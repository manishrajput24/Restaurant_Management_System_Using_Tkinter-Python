...
root.title('Restaurant Management System created by Manish Rajput')
...
labelTitle=Label(topFrame,text='MJ RESTAURANT',font=('arial',30,'bold'),fg='red',bd=9,
                 bg='orange',width=51)
...
button7=Button(calculatorFrame,text='7',font=('arial',16,'bold'),fg='WHITE',bg='BLACK',bd=6,width=6,
               command=lambda:buttonClick('7'))
button7.grid(row=1,column=0)

button8=Button(calculatorFrame,text='8',font=('arial',16,'bold'),fg='WHITE',bg='BLACK',bd=6,width=6,
               command=lambda:buttonClick('8'))
button8.grid(row=1,column=1)

button9=Button(calculatorFrame,text='9',font=('arial',16,'bold'),fg='WHITE',bg='BLACK',bd=6,width=6
               ,command=lambda:buttonClick('9'))
button9.grid(row=1,column=2)

buttonPlus=Button(calculatorFrame,text='+',font=('arial',16,'bold'),fg='WHITE',bg='BLACK',bd=6,width=6
                  ,command=lambda:buttonClick('+'))
buttonPlus.grid(row=1,column=3)

button4=Button(calculatorFrame,text='4',font=('arial',16,'bold'),fg='WHITE',bg='BLACK',bd=6,width=6
...
buttonMinus=Button(calculatorFrame,text='-',font=('arial',16,'bold'),fg='WHITE',bg='BLACK',bd=6,width=6
                   ,command=lambda:buttonClick('-'))
buttonMinus.grid(row=2,column=3)

button1=Button(calculatorFrame,text='1',font=('arial',16,'bold'),fg='WHITE',bg='BLACK',bd=6,width=6
...
buttonMult=Button(calculatorFrame,text='*',font=('arial',16,'bold'),fg='WHITE',bg='BLACK',bd=6,width=6
                  ,command=lambda:buttonClick('*'))
